# Understand Word Counts, Repetitions, and Estimated Time
...
Estimated time is based on typical processing speed and current load. Actual timing may vary.

## Related Articles

- [Understand words and word wallets](../plans-and-billing/words-and-wallets.md)
- [When termbase adds words to a check](../terminology-and-filters/termbase-adds-words.md)
